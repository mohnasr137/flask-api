...
def home():
    return render_template("./templates/index.html", image_path=None)
...
#         return render_template("./templates/index.html", image_path=image_path)
...
def signupPage():
    return render_template("./templates/signup.html", image_path=None)
...
def loginPage():
    return render_template("./templates/login.html", image_path=None)
